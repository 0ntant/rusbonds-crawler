...
@Slf4j
public class SelRusbondsService
{
    ...
    protected ChromeOptions setOptions()
    {
        return new ChromeOptions();
    }

    protected RemoteWebDriver createRemoteDriver(ChromeOptions options)
    {
    ...
    protected void setRusbondsKeys()
    {
    ...
    protected void waitDriver(int waitSec)
    {
